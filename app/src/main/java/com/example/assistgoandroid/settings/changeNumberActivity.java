    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == 100 && resultCode == RESULT_OK){
            ...
            if (resultString.equalsIgnoreCase("go to the main screen")) {
                Intent intent = new Intent(changeNumberActivity.this, MainActivity.class);
                ...
                Intent intent = new Intent(changeNumberActivity.this, emergencyActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(changeNumberActivity.this, homemessageActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(changeNumberActivity.this, translateActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(changeNumberActivity.this, callActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(changeNumberActivity.this, contactActivity.class);
                startActivity(intent);

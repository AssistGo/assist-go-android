    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == 100 && resultCode == RESULT_OK){
            ...
            if (resultString.equalsIgnoreCase("go to the main screen")) {
                ...
                Intent intent = new Intent(EnteringActivity.this, emergencyActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(EnteringActivity.this, homemessageActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(EnteringActivity.this, translateActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(EnteringActivity.this, callActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(EnteringActivity.this, settingsActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(EnteringActivity.this, contactActivity.class);
                startActivity(intent);

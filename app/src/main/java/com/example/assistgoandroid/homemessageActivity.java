    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == 100 && resultCode == RESULT_OK){
            ...
            if (resultString.equalsIgnoreCase("go to the main screen")) {
                Intent intent = new Intent(homemessageActivity.this, MainActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(homemessageActivity.this, emergencyActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(homemessageActivity.this, homemessageActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(homemessageActivity.this, translateActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(homemessageActivity.this, callActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(homemessageActivity.this, settingsActivity.class);
                startActivity(intent);

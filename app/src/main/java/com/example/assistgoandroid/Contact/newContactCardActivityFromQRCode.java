...
public class newContactCardActivityFromQRCode extends AppCompatActivity {
    Bitmap mBitmap;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_contact_activity_from_qrscan);

        contactName = findViewById(R.id.editContactNameQR);
        contactPhoneNumber = findViewById(R.id.editContactPhoneNumberQR);
        contactProfilePicture = findViewById(R.id.ivContactProfilePictureQR);

        loadQRData((String)getIntent().getExtras().get("data"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == 100 && resultCode == RESULT_OK){
            ...
            if (resultString.equalsIgnoreCase("go to the main screen")) {
                Intent intent = new Intent(newContactCardActivityFromQRCode.this, MainActivity.class);
                ...
                Intent intent = new Intent(newContactCardActivityFromQRCode.this, emergencyActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(newContactCardActivityFromQRCode.this, homemessageActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(newContactCardActivityFromQRCode.this, translateActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(newContactCardActivityFromQRCode.this, callActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(newContactCardActivityFromQRCode.this, settingsActivity.class);
                startActivity(intent);
                ...
                Intent intent = new Intent(newContactCardActivityFromQRCode.this, contactActivity.class);
                startActivity(intent);
    ...
    private void checkPermissionForNewContact(){
        if (ContextCompat.checkSelfPermission(newContactCardActivityFromQRCode.this, Manifest.permission.WRITE_CONTACTS) != PackageManager.PERMISSION_GRANTED) {
    ...
    private void checkPermissionForGallery() {
        if (ContextCompat.checkSelfPermission(newContactCardActivityFromQRCode.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
    ...
    private void loadQRData(String data){
        Log.d("newContactCardActivity", "loadQRData: " + data);
        String [] contactComponents = data.split("@");
        contactName.setText(contactComponents[0]);
        contactPhoneNumber.setText(contactComponents[1]);
    }
}